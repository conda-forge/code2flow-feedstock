...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/code2flow-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14951&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/code2flow-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `code2flow` can be installed with:

```
conda install code2flow
```

It is possible to list all of the versions of `code2flow` available on your platform with:
